...
$headers[] = 'X-Location: -6.405821,106.064193';
        ...
        echo "\n";
        echo "\e[92m--------------------------------------------------\n";
        echo "\e[92m|              SCRIPT BY RENAME               |\n";
        echo "\e[92m|            Komunitas Morat marit            |\n";
        echo "\e[92m|     https://github.com/kenwisnoe/voucher   |\n";
        ...
        if($regs->success == true) {
            ...
            if($verifs->success == true) {
                ...
                // COBAGOFOOD090320A
                echo "\e[96m[!] Proses Reedem Voucher 15+10+5 : COBAGOFOOD090320A \n";
                $data3 = '{"promo_code":"COBAGOJEK090320A"}';
                                        ...
                                        if($claims1->success == true) 
                                                {
                                                ...
                                                } else 
                                                    {
                                                        echo "\e[91m [×] Gagal Claim Voucer !";
                                                            ...
                                                            // COBAGORIDE
                                                                echo "\e[96m[!] Proses Redeem Voucher 8K : COBAGORIDE \n";
                                                                $data5 = '{"promo_code":"COBAGORIDE"}';
                                                                ...
                                                                if($claims2->success == true) 
                                                                        {
                                                                        ...
                                                                        } else 
                                                                            {
                                                                                echo "\e[91m [×] Gagal Claim Voucer !";
                                                                                    ...
                                                                                    // BELANJAINAJA
                                                                                        echo "\e[96m[!] Proses Redeem Voucher  : BELANJAINAJA \n";
                                                                                        $data6 = '{"promo_code":"BELANJAINAJA"}';
